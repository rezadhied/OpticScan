    ...
    <body>
        <div id="app" class="d-flex">
            <!-- Sidebar -->
            <div class="d-flex flex-column p-3 vh-100 fixed-sidebar">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="{{ Auth::user()->role === 'dokter' ? route('dashboardDokter') : route('dashboardpasien') }}"
                            ...
                            <img src="/img/home.png" alt="" style="width: 20px; height: 20px;">
                            Beranda
                        </a>
                        ...
                        <a href="{{ route('infopenyakit') }}"
                            ...
                            <img src="/img/riwayat.png" alt="" style="width: 20px; height: 20px;">
                            Riwayat
                        </a>
                        <a href="{{ route('tkami') }}" class="nav-link d-flex align-items-center gap-2 text-white"
                            ...
                            <img src="/img/team.png" alt="" style="width: 20px; height: 20px;">
                            Tentang Kami
                        </a>
                    </li>
                </ul>
