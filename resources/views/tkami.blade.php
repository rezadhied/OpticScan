...
<body>
    <div style="position: relative;">
        <img src="/img/tkami.jpg" class="w-100" style="height: 560px;">
        <div class="container-fluid" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; color: white;">
            <h1 style="font-weight: bolder; font-size: 80px;">
                Tentang OpticScan
            </h1>
            <h5 style="font-weight: lighter; font-size: 40px;">
    ...
    <div class="container text-center">
        ...
        <div class="row align-items-center">
            <div class="col-md-4 order-md-11">
                <img src="/img/visi.jpg" class="img-fluid rounded" style="height: 300px; width: 700px; object-fit: cover; margin-left: 230px;" alt="">
            </div>                                   
            <div class="col-md-6 order-md-1">
                ...
                <p style="font-size: 25px; text-align: justify;" class="col-md-11 d-md-block p-0">
        ...
        <div class="row align-items-center">
            <div class="col-md-4 order-md-7">
                <img src="/img/misi.jpg" class="img-fluid rounded" style="height: 300px; width: 700px; object-fit: cover;" alt="">
            </div>                                   
            <div class="col-md-6 offset-md-1 order-md-11">
                <h3 style="text-align: justify; font-size: 50px; margin-left: 130px; color: #132768;">Misi</h3>
                <p class="nav-item active" style="border-bottom: 3px solid #132768; margin-left: 130px; width: 100px;"></p>
                <p style="font-size: 25px; text-align: justify; margin-left: 130px;" class="col-md-12 d-md-block p-0">
                    Mengembangkan sistem berbasis IoT dan algoritma kecerdasan buatan untuk memantau dan menganalisis faktor-faktor yang berkaitan dengan penyakit mata, serta menyediakan solusi yang terjangkau dan mudah diakses bagi masyarakat umum dan fasilitas kesehatan.                </p>
            </div>
        </div>
    </div><br><br><br>
